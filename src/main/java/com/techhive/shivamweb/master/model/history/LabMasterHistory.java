...
@Entity
@Table(name = ShivamWebVariableUtils.TABLE_NAME_FOR_LABMASTER_HISTORY)
@JsonInclude(Include.NON_EMPTY)
@EntityListeners(AuditingEntityListener.class)
public class LabMasterHistory {

	@Id
	@GeneratedValue(generator = "system-uuid")
	@GenericGenerator(name = "system-uuid", strategy = "uuid")
	@Column(name = "labMasHistId", nullable = false, insertable = false, updatable = false)
	private String id;

	public LabMasterHistory() {
		super();
	}

	public LabMasterHistory(LabMaster labMaster, EnumForAction action) {
		super();
		this.action = action;

		this.idOfEntity = labMaster.getId();

		this.labMasterName = labMaster.getLabMasterName();

		this.labMasterOrder = labMaster.getLabMasterOrder();
