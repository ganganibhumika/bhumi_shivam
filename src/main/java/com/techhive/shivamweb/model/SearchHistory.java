...
import com.techhive.shivamweb.filter.MyJsonDateSerializerForApp;
import com.techhive.shivamweb.master.model.User;
import com.techhive.shivamweb.utils.ShivamWebMethodUtils;
import com.techhive.shivamweb.utils.ShivamWebVariableUtils;

@Entity
@Table(name = ShivamWebVariableUtils.TABLE_NAME_FOR_SEARCH_HISTORY)
@JsonInclude(Include.NON_EMPTY)
public class SearchHistory extends Auditable<String> {

	@Id
	@GeneratedValue(generator = "system-uuid")
	@GenericGenerator(strategy = "system-uuid", name = "uuid")
	@Column(name = "searchHistoryId", insertable = false, nullable = false, updatable = false)
	private String id;
	...
	@Transient
	private Integer pktCnt;
	
	// this field use only app (to set format).
	@Transient
	@JsonSerialize(using = MyJsonDateSerializerForApp.class)
	...
	public SearchHistory(String id, String name) {
		super();
		this.id = id;
		this.name = name;
	}
	...
	public Integer getPktCnt() {
		return pktCnt;
	}

	public void setPktCnt(Integer pktCnt) {
		this.pktCnt = pktCnt;
	}
