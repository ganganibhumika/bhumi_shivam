...
import com.techhive.shivamweb.listners.CreateDemandListner;
import com.techhive.shivamweb.master.model.User;
import com.techhive.shivamweb.utils.ShivamWebMethodUtils;
import com.techhive.shivamweb.utils.ShivamWebVariableUtils;

@Entity
@Table(name = ShivamWebVariableUtils.TABLE_NAME_FOR_CREATE_DEMAND)
@JsonInclude(Include.NON_EMPTY)
@EntityListeners(CreateDemandListner.class)
public class CreateDemand extends Auditable<String> {
	@Id
	@GeneratedValue(generator = "system-uuid")
	@GenericGenerator(strategy = "system-uuid", name = "uuid")
	@Column(name = "createDemandId", insertable = false, nullable = false, updatable = false)
	private String id;
	...
	public CreateDemand(String id, String name) {
		super();
		this.id = id;
		this.name = name;
	}
